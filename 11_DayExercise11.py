...
print('Ejericio 3')
def add_all_nums(*a):
    if not all(isinstance(num, (int, float)) for num in a):
...
def check_season(e4):
    ...
    e5 = e4.lower()  
    return estaciones.get(e5, 'Error: Mes no válido')

#Ejercicio 6
print('Ejericio 6')
def calculate_slope(x1, y1, x2, y2):
    if x1 == x2:
        return 'Error: La pendiente es indefinida (división por cero)'
    return (y2 - y1) / (x2 - x1)
...
def solve_quadratic_eqn(a, b, c):
    minante = b**2 - 4*a*c  
    if minante > 0:
        a = (-b + math.sqrt(minante)) / (2 * a)
        a2 = (-b - math.sqrt(minante)) / (2 * a)
        return a, a2
    elif minante == 0:
        x = -b / (2 * a)
        return x,
        ...
        real = -b / (2 * a)
        imag = math.sqrt(abs(minante)) / (2 * a)
...
def capitalize_list_items(l):
    if type(l) == list:
        ...
        return f'{l} is not a list'
    return capitems

#Ejercicio 11
print('Ejericio 11')
def add_item(first, i):
    first.append(i) 
    return first
...
#Ejercicio 13
print('Ejericio 13')
def sum_of_numbers(suma):
    return sum(range(1, suma + 1))  
...
def sum_of_odds(odds):
    return sum(num for num in range(1, odds + 1) if num % 2 != 0)

#Ejercicio 15
print('Ejericio 15')
def sum_of_even(even):
    return sum(num for num in range(1, even + 1) if num % 2 == 0)

print('NIVEL 2')

#Ejercicio 1
print('Ejericio 1')
def evens_and_odds(e1):
    eve = sum(1 for num in range(e1 + 1) if num % 2 == 0)
    od = e1 + 1 - eve 
    return f'Números pares: {eve}, Números impares: {od}'
...
def calculate_mode(e3):
    ...
    if not e3:
        return None
    moda = Counter(e3)
    maxc = max(moda.values())
    modota = [k for k, val in moda.items() if val == maxc]
...
numbers = [1, 2, 2, 3, 4, 7, 9]

print('La media: ', calculate_mean(numbers))      
print('La mediana: ', calculate_median(numbers)) 
print('La moda: ', calculate_mode(numbers))       
print('El rango: ', calculate_range(numbers))     
print('La varianza: ', calculate_variance(numbers))  
print('La desviación estándar: ', calculate_std(numbers)) 
...
for country in most_populated_countries(countries, 10):
